...
var store20 = new IDBStore({			//Creating Instance of the Objectstore
  ...
  onStoreReady: function(){
    console.log('Store20 ready!');		//If everything goes perfect Display "store is readt"
  },
  indexes: [
    { name: 'info', keyPath: 'info', unique: false, multiEntry: false }     // Indexing key, other than keypath to using in query
  ]
});
//Another Objectstore
